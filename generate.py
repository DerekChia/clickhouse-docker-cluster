...
if __name__ == "__main__":
    ...
    # general
    parser.add_argument("--ch-version", type=str, default="24.8", help="ClickHouse version")
    ...
    parser.add_argument("--memory-keeper", type=str, default="2048m", help="RAM (mb) for each node")
